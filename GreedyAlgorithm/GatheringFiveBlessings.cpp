...
// int GatheringFiveBlessings(char** vec);
...
int main()
{
    ...
    printf(" %d\n", n);
    char arr[] = "abvdsfsdfsd";
    char *s = GenerateRandomString(n, (char *)arr);
    PrintString(s);
    // char** strs = generateRandomStringVector(n, 5, 5);
...
// vector<string> generateRandomStringVector(int n, int low, int high, char* arr)
// {
//     vector<string> vec;
//     srand((int)time(0));
//     for (int i = 0; i < n; i++)
