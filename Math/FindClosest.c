...
int main()
{
    int x = GenerateRandomNum(1, 99);
    int y = GenerateRandomNum(1, 100);
    int z = GenerateRandomNum(1, 101);
    int ans = FindClosest(x, y, z);
    printf("数轴上三个人的位置 为 %d %d %d\n", x, y, z);
    printf("第 %d 个人 先 到达第 3 个人的位置\n", ans);
}
